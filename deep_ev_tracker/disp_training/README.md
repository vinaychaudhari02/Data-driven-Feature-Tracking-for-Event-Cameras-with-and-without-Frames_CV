...
To test the disparity method on the M3ED dataset, we need to first run the evaluation script `evaluate.py` or `evaluate_visualize.py` to visualize disparity.
